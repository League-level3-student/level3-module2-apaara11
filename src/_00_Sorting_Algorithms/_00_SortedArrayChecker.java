...
public static boolean intArraySorted(int integer[]) {
	boolean integerArrayIsAscending = false;
	
	if(integerArrayIsAscending==true) {
		
	}
	return integerArrayIsAscending;
}
...
public static boolean stringArraySorted(String strings[]) {
	boolean stringIsInOrder = false;
	
	if(stringIsInOrder==true) {
		return true;
	}
	else {
		return false;
